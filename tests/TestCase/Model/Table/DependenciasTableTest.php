...
class DependenciasTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('Dependencias') ? [] : ['className' => DependenciasTable::class];
        $this->Dependencias = TableRegistry::getTableLocator()->get('Dependencias', $config);
    }

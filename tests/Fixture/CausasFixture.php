...
class CausasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'unidad_fiscal' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'causas_ibfk_1' => ['type' => 'foreign', 'columns' => ['dependencia_id'], 'references' => ['dependencias', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
            'causas_ibfk_2' => ['type' => 'foreign', 'columns' => ['origen_id'], 'references' => ['origenes', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
            'causas_ibfk_3' => ['type' => 'foreign', 'columns' => ['jurisdiccion_id'], 'references' => ['jurisdicciones', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
            'causas_ibfk_4' => ['type' => 'foreign', 'columns' => ['circunscripcion_id'], 'references' => ['circunscripciones', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'unidad_fiscal' => 'Lorem ipsum dolor sit amet',
                'created' => '2019-11-05 11:32:48',
                'modified' => '2019-11-05 11:32:48',
                'dependencia_id' => 1,
                'origen_id' => 1,
                'jurisdiccion_id' => 1,

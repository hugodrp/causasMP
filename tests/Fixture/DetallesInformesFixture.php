...
class DetallesInformesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'categoria_informe' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'nro_nota_recibida' => 1,
                'fecha_nota_recibida' => '2019-09-23',
                'fecha_asignacion' => '2019-09-23',
                'fecha_inicio_informe' => '2019-09-23',
                ...
                'feha_entrega_informe' => '2019-09-23',
                'categoria_informe' => 'Lorem ipsum dolor sit amet, aliquet feugiat. Convallis morbi fringilla gravida, phasellus feugiat dapibus velit nunc, pulvinar eget sollicitudin venenatis cum nullam, vivamus ut a sed, mollitia lectus. Nulla vestibulum massa neque ut et, id hendrerit sit, feugiat in taciti enim proin nibh, tempor dignissim, rhoncus duis vestibulum nunc mattis convallis.',
                'created' => '2019-09-23 16:54:32',
                'modified' => '2019-09-23 16:54:32',
                'detalle_causa_id' => 1,
                'persona_id' => 1
            ],
        ];

...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $detallesComunicacione->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $detallesComunicacione->id)]
            )
        ?></li>
...
<div class="detallesComunicaciones form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Detalles Comunicacione') ?></legend>
        <?php
